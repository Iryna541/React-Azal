...
export function transformLabourEfficiencyReportData(
  ...
  newList.push({
    ...
    total: "Gross Sales",
    id: aggregate_values?.[0].id,
    sales: parseFloat(grossSales.toFixed(1)),
    estGuestsPerLH: "",
    actualGuestsPerLH: "",
    actualSalesPerLH: "",
  });
  ...
  newList.push({
    ...
    meal: "",
    total: "Gross Payroll",
    sales: parseFloat(grossPayroll.toFixed(2)),
    estGuestsPerLH: "",
    actualGuestsPerLH: "",
    actualSalesPerLH: "",
  });
  newList.push({
    ...
    sales: parseFloat(grossDirectLabor.toFixed(1)),
    estGuestsPerLH: "",
    actualGuestsPerLH: "",
    actualSalesPerLH: "",
  });
  ...
  newList.push({
    ...
    meal: "",
    total: "Gross Labor $",
    sales: parseFloat(grossLabor.toFixed(1)),
    estGuestsPerLH: "",
    actualGuestsPerLH: "",
    actualSalesPerLH: "",
  });
  newList.push({
    ...
    meal: "",
    total: "Gross Labor %",
    sales: parseFloat(grossLaborPercentage.toFixed(2)),
    estGuestsPerLH: "",
    actualGuestsPerLH: "",
    actualSalesPerLH: "",
  });
