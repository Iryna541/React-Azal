...
import { StoreInsights } from "./api/useR365StoreRanking";
import { useState } from "react";
import { marked } from "marked";

interface R365StoreRankingTableProps {
  data: StoreInsights[];
}

export function R365StoreRankingTable({ data }: R365StoreRankingTableProps) {
  const PAGE_SIZE = 10;
