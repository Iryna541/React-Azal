...
export const salesColumnsForDemo: ColumnDef<SalesData>[] = [
  {
    accessorKey: "store_name",
    header: () => <Text
      fw={700}
...
export const salesBuildingColumnsForDemo: ColumnDef<SalesBuildingData>[] = [
  {
    accessorKey: "store_name",
    header: () => <Text
      fw={700}
...
export const driveThruColumnsForDemo: ColumnDef<DriveThruData>[] = [
  {
    accessorKey: "store_name",
    header: () => <Text
      style={{ textAlign: "center", fontSize: "14px", color: "white" }}
...
export const costDataColumnsForDemo: ColumnDef<CostData>[] = [
  {
    accessorKey: "store_name",
    header: () => <Text
      style={{ textAlign: "center", fontSize: "14px", color: "white" }}
...
export const laborInfoColumnsForDemo: ColumnDef<LaborInfoData>[] = [
  {
    accessorKey: "store_name",
    header: () => <Text
      style={{ textAlign: "center", fontSize: "14px" }}
...
export const guestSatisfactionColumnsForDemo: ColumnDef<GuestSatisfactionData>[] = [
  {
    accessorKey: "store_name",
    header: () => <Text
      style={{ textAlign: "center", fontSize: "14px", color: "white" }}
