...
import { ManagerPlanResponse } from "./api/useDunkinManagerPlan"; // Update the import based on actual file structure
import { useState } from "react";

interface DunkinManagerPlanTableProps {
              ...
              {headerGroup.headers.map((header) => {
                return (
                  <>
                    ...
                    <Table.Th>Managers plan</Table.Th>
                  </>
                );
              })}
            </Table.Tr>
